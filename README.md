...
```bash
git clone https://github.com/RaisaNuzhat/nextgen-hackathon-greensoul-careervista-server.git
cd nextgen-hackathon-greensoul-careervista-server
```
...
Create a `.env` file in the root directory and set up configurations.
